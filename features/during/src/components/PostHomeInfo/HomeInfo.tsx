...
export const PostHomeInfo = ({ title, address, price, discount, finalFee, specs, seenStatus }: HomeInfoProps) => {
  return (
    <Box className={styles.container}>
      ...
      <Text variant="rayse-20700" color="#171717">
        {address}
      </Text>

      <Box className={styles.priceRow}>
        <Text variant="rayse-20700" color="#161616" paddingTop="3px">
          {price}
        </Text>
        {discount && (
          <Box
        ...
        {finalFee && (
          <Box paddingTop="3px">
            <Text variant="rayse-18700" color="#525252">
              {finalFee}
            </Text>
...
const RenderSpec = ({ spec }: { spec: HouseSpec }) => (
  <>
    <Text variant="rayse-18700" color="#161616">
      {spec.value}
    </Text>
