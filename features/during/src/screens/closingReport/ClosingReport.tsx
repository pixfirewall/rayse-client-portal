...
export const ClosingReport: React.FC<ClosingReportProps> = ({ isJourneyClosed = false }) => {
  ...
  const { daysWorked, outcomesFinished, activities, report, agentPicture, agentEmail, agentPhone, ...details } =
    agentActivityData.closingReport
    ...
    <Grid container className={styles.topContainer}>
      ...
      <Grid item xs={12}>
        <Box className={styles.headerContainer}>
          ...
          >
            <Text variant="rayse-14700" color="#161616">
              {isJourneyClosed ? 'Closing report' : 'Agent activities'}
            </Text>
          </Box>
        </Box>
      </Grid>
        ...
        <Box className={styles.mainContainer}>
          <Box className={styles.capsuleContainer}>
            <Box className={styles.capsules}>
              ...
              <Text variant="rayse-24700" color="#FFF" paddingTop="18px">
                {daysWorked}
              </Text>
              <Text variant="rayse-16400" color="#FFF">
                Days
              </Text>
            </Box>
