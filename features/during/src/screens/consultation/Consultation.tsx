      ...
      <Group dir="vertical" gap={24}>
        ...
        <Group dir="vertical">
          ...
          <Text variant="rayse-18400">
            During the consultation, we will gather important information about your preferences, budget, and timeline,
            and will answer any questions about the home buying process.
          </Text>
        </Group>
