      ...
      <Box className={styles.mainSection}>
        ...
        <Box className={styles.roundCard} style={{ background: '#F8F7F4' }}>
          ...
          <Text variant="rayse-24400">
            Presenting your highly detailed, meticulously documented, all-in-one forever record of your unique path to
            home ownership. This is what success looks like.
          </Text>
        </Box>
        ...
        <Box className={styles.multiColumnSection}>
          <Box className={styles.roundCard} style={{ background: '#D9D4C8', width: '100%' }}>
            ...
            <Text variant="rayse-24400">It’s been a pleasure to share this journey. Thank you.</Text>
          </Box>
        ...
        <Box className={styles.bottomCard}>
          ...
          <LongButton color="darkGreen" onClick={navigateToYourAgent}>
            <Space />
            <Text variant="rayse-20700">Contact {agentInfo?.user?.firstName}</Text>
            <Box
