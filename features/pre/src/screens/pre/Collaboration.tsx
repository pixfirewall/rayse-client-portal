      ...
      <Box className={styles.mainSection}>
        ...
        <Box className={styles.roundCard} style={{ background: '#F8F7F4' }}>
          ...
          <Text variant="rayse-24400">
            Typically it takes touring three to 10 homes to get into contract. Whatever it takes, you’ll have an expert
            in your corner so you won’t have surprises in the corners.
          </Text>
        </Box>
        ...
        <Box className={styles.multiColumnSection}>
          <Box className={styles.roundCard} style={{ background: '#EEECE6', width: '100%' }}>
            ...
            <Text variant="rayse-24400">Prepare to be moved to cheers.</Text>
          </Box>
