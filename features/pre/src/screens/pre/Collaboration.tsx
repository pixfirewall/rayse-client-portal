...
export const Collaboration = () => {
  ...
  if (isNaN(agentId)) {
    return (<Box>
      * ERROR: Please provide the agent id in the url. Example: <Link href={`/collaboration?agentId=${DEFAULT_AGENT_ID}`} color="primary">
        /collaboration?agentId={DEFAULT_AGENT_ID}
      </Link>
    </Box>)
  }
