...
import { Box, Text, LongButton, WhiteIcon, RayseIcon, RoundCard, Link, Image } from '@rayseinc-packages/ui'
...
export const SecondaryPage = () => {
  ...
  const agentId =
    Number(queryString.parse(location.search)?.['agentId']) || usePreSelector(state => state.PRE_REDUCER_PATH.agentId)
    ...
    return (
      <Box>
        * ERROR: Please provide the agent id in the url. Example:{' '}
        <Link href={`/pre-2nd?agentId=${DEFAULT_AGENT_ID}`} color="primary">
    ...
    <Box className={styles.topContainer}>
      ...
      <Box className={styles.topNavBar}>
        <LongButton color="darkGreen" onClick={() => navigateToPre()}>
          ...
          <Text variant="rayse-20700">Back to {agentInfo?.user?.firstName}</Text>
          <Box
      ...
      <Box className={styles.subSection}>
        ...
        <Text variant="rayse-40700" paddingTop="16px">
          I can make it appear effortless.
        </Text>
      ...
      <Box className={styles.cardSection}>
              ...
              <Box width="100%" alignSelf="flex-start">
                ...
                >
                  ...
                  <Box sx={{ 'text-align': 'left' }}>
                    ...
                    <Text variant="rayse-14700" color="#171717">
                      {' '}
                      208 Brixton Ave
                    </Text>
                  </Box>
            ...
            <RoundCard color="#D9D4C8" hPadding="36px" vPadding="36px" height="410px" gap="80px" align="flex-start">
              <Box className={styles.sampleHouseInfo}>
                ...
                <RoundCard
                  ...
                  left={0}
                >
                  <Box className={styles.houseThumbnail} />
                  <Box sx={{ 'text-align': 'left' }}>
                    <Text variant="rayse-16400" color="#171717">
                      Tell me how you felt about
                    </Text>
                    <Text variant="rayse-16700" color="#171717">
                      {' '}
                      208 Brixton Ave
                    </Text>
                  </Box>
        ...
        <Box
          onClick={() => navigateToPreClosingReport()}
          style={{
            cursor: 'pointer',
            width: '100%',
          }}
